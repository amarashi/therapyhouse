...
export function createDogEyeController({
  ...
  function renderEye(eye) {
    ...
    element.style.setProperty("--eye-size", `${formatNumber(eye.size)}px`);
    element.style.setProperty("--pupil-size", `${formatNumber(eye.pupilSize)}px`);
    element.style.setProperty("--pupil-x", "0px");
    element.style.setProperty("--pupil-y", "0px");
  ...
  function resetPupils() {
    ...
    layer.querySelectorAll(".dog-eye").forEach((eyeElement) => {
      eyeElement.style.setProperty("--pupil-x", "0px");
      eyeElement.style.setProperty("--pupil-y", "0px");
    });
  }
  ...
  function updatePupils(clientX, clientY) {
    ...
    currentSettings.eyes.forEach((eye) => {
      ...
      eyeElement.style.setProperty("--pupil-x", `${formatNumber(pupilX)}px`);
      eyeElement.style.setProperty("--pupil-y", `${formatNumber(pupilY)}px`);
    });
  }
